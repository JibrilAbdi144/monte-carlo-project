...
- [x] Fix poor formatting of results table in README.md
- [ ] Create src directory to contain python scripts
- [ ] Create tabulate.py and convergence-plot.py
- [ ] Add title, labels and other details to plot
- [ ] Alter program structure to make it more modular and versatile
